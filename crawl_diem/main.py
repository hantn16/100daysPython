...
def Crawl_THPTQG(so_bao_danh):
    ...
    URL = "https://vietnamnet.vn/giao-duc/diem-thi/tra-cuu-diem-thi-tot-nghiep-thpt/2023/{}.html".format(
        so_bao_danh)
    r = session.get(URL)
...
if __name__ == "__main__":
    ...
    with open("Output.csv", "a", encoding='utf-8') as f:
        for result in result_iter:
            f.write(result)
            print("Đang xử lý điểm của thí sinh số {}".format(
                result.split(',')[0]))
